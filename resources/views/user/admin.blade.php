...
<title>iPOS MBLB Admin</title>
@section('content')
<div class="container-fluid">

                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800"><b>Tabel Data Admin</b></h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <!-- <h6 class="m-0 font-weight-bold text-primary">Tabel Data Produk</h6> -->
                            <form>
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addProduct" style="float: right;">Tambah Admin <i class="fa fa-plus"></i>
                            </button>
                            </form>
